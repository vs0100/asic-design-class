...
\TLV
   ...
   |calc
      @1
         ...
         $f[31:0] = $reset ? (($sel[1:0] == 0) ? $sum : ($sel[1:0]==1) ? $diff : ($sel[1:0]==2) ? $prod : $quot):0;
         
      //@2
         
         //$f[31:0] = $valid_or_reset ? (($sel[1:0] == 0) ? $sum : ($sel[1:0]==1) ? $diff : ($sel[1:0]==2) ? $prod : $quot):0;
...
![Screenshot (436)](https://github.com/user-attachments/assets/c7545889-4d35-461c-ba16-91bf74ab0041)
...
```
![Screenshot (437)](https://github.com/user-attachments/assets/1cd31c1e-e3e9-46e5-9fab-831b55e2082e)
...
## Task - 2 : RISCv Core without Pipeline
```
\m4_TLV_version 1d: tl-x.org
\SV
   ...
   |cpu
      ...
      @1
         ...
         $imm[31:0] = $is_i_instr ? { {21{$instr[31]}}, $instr[30:20] }:
                      $is_s_instr ? { {21{$instr[31]}}, $instr[30:20] }:
         ...
         $taken_branch = $is_beq ? ($src1_value == $src2_value):
                         ...
                         $is_bge ? ((($src1_value > $src2_value) ||($src1_value == $src2_value))^($src1_value[31] != $src2_value[31])):
                         $is_bltu ? ($src1_value < $src2_value):
                         $is_bgeu ? (($src1_value > $src2_value) || ($src1_value == $src2_value)) :
                                    1'b0;
...
```
![Screenshot (440)](https://github.com/user-attachments/assets/f85e604c-b4ce-4184-8a81-90b2f6590bc3)
